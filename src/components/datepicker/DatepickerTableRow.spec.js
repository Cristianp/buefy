...
describe('BDatepickerTableRow', () => {
    ...
    describe('classObject', () => {
        it('will has is-selected class for all range of dates selected', () => {
        ...
        it('will have is-first class for the first date selected within the range', () => {
            const wrapper = shallowMount(BDatepickerTableRow, {
                propsData: {
                    ...propsData,
                    selectedDate: [propsData.week[1], propsData.week[5]]
        ...
        it('will have is-within class for the dates selected within the range', () => {
            const wrapper = shallowMount(BDatepickerTableRow, {
                propsData: {
                    ...propsData,
                    selectedDate: [propsData.week[1], propsData.week[5]]
        ...
        it('will have is-last class for the last date selected within the range', () => {
            const wrapper = shallowMount(BDatepickerTableRow, {
                propsData: {
                    ...propsData,
                    selectedDate: [propsData.week[1], propsData.week[5]]
