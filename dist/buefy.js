...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: {
        ...
        dateFormatter: {
            ...
            default: function _default(date) {
                ...
                return targetDates.map(function (targetDate) {
                    var yyyyMMdd = targetDate.getFullYear() + '/' + (targetDate.getMonth() + 1) + '/' + targetDate.getDate();
                    var validDate = new Date(yyyyMMdd);
    ...
    data: function data() {
        var focusedDate = Array.isArray(this.value) ? this.value[0] : this.value || this.focusedDate || new Date();
    ...
    watch: {
        ...
        */
        dateSelected: function dateSelected(value) {
            var currentDate = Array.isArray(value) ? value[0] : !value ? new Date() : value;
        ...
        */
        classObject: function classObject(day) {
            ...
            return {
                ...
                'is-first': dateMatch(day, Array.isArray(this.selectedDate) && this.selectedDate[0]),
                'is-within': dateWithin(day, this.selectedDate),
                'is-last': dateMatch(day, Array.isArray(this.selectedDate) && this.selectedDate[1]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: {
        value: {
            type: [__WEBPACK_IMPORTED_MODULE_1__utils_ssr__["a" /* File */], Array]
        },
        multiple: Boolean,
        disabled: Boolean,
        accept: String,
